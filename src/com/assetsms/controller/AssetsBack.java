...
public class AssetsBack extends BaseController implements Initializable {
    ...
    private void submit(ActionEvent event) {
        ...
        //得到窗口中输入的客户信息
        AssetsTrjn assetsTrjn = new AssetsTrjn("归还",selectAssets.getAssetsID(), date,
    ...
    private void showComboData() {
        ...
        //把AssetsData中满足条件的数据添加到列表中,初始化Assets表项和表中的内容，状态项必须为’领用‘
        FilteredList<Assets> filteredData = new FilteredList<>(assetsData, n -> true);

        filteredData.setPredicate(n -> n.getStatus().contains("领用"));
